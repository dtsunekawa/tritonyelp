...
subway_review_3 = Review.create! :content => 'Wilted veggies and cheap meat, and nasty manufactured cheese - no thanks.', 
...
bombay_review_3 = Review.create! :content => 'Everything tastes the same, not worth the money. If I want Indian food I\'ll go to Punjabi Tandoor!!!!!!', 
